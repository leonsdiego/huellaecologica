...
class Model_Cuestionario 
{
	...
	public function nuevoCuestionario($idUsuario,$idEncuesta,$idIndicadorCabeza)
	{
		return Model_Mapper_Cuestionario::getInstance()->nuevoCuestionario($idUsuario,$idEncuesta,$idIndicadorCabeza);
	}
